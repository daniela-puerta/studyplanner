                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="nav nav-underline me-auto align-items-center">
                            ...
                            <li class="nav-item dropdown d-flex align-items-center d-none d-md-block">
                                <a class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Tareas</a>
                ...
                <div class="container mt-4">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <img src="../assets/in_progress.jpg" alt="Imagen decorativa" class="img-fluid rounded-4">
                        </div>
